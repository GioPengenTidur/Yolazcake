...
<head>
  ...
  <style>
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    .preview{width:100%;max-height:220px;object-fit:cover;border-radius:14px;margin-bottom:18px;
    ...
    select option{background:#1e0e3a;}
  ...
  <div class="form-card">
    ...
    <form method="POST" enctype="multipart/form-data">
      <div class="form-group">
        ...
        <input type="text" name="judul" value="<?= htmlspecialchars($data['judul']) ?>" maxlength="100" required>
      </div>
      <div class="form-group">
