...
// balik ke halaman login setelah akun berhasil dibuat (mis. user yang
// tadinya mau booking meja tapi belum punya akun).
...
$loginLinkQs = $carryQuery ? ('?' . http_build_query($carryQuery)) : '';
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<body>
  ...
  <!-- Back link -->
  <a href="login.php<?= $loginLinkQs ?>" class="back-link">&#8592; Kembali ke Login</a>
  ...
  <div class="login-wrapper">
    <div class="login-card">
      ...
      <div class="login-brand">
        <span class="eyebrow"><i data-lucide="sparkles" class="lucide-ic"></i> Bergabung Dengan Kami</span>
        <h1>YOLAZCAKE</h1>
      ...
      <div class="error-msg" id="errorMsg">
        <i data-lucide="alert-triangle" class="lucide-ic"></i> <span id="errorText">Terjadi kesalahan. Coba lagi.</span>
      </div>
      ...
      <form class="login-form" action="proses_register.php" method="POST" id="registerForm" novalidate>
        ...
        <div class="field-group">
          ...
          <div class="input-wrap">
            ...
            <button type="button" class="toggle-eye" id="toggleConfirm" tabindex="-1" aria-label="Tampilkan password"><i data-lucide="eye" class="lucide-ic icon-eye"></i><i data-lucide="eye-off" class="lucide-ic icon-eye-off"></i></button>
          </div>
      ...
      <div class="login-footer">
        Sudah punya akun? <a href="login.php<?= $loginLinkQs ?>">Masuk</a>
      </div>
    ...
    registerForm.addEventListener('submit', async function (e) {
      ...
      try {
        const res = await fetch('proses_register.php', {
          ...
          body: new URLSearchParams({ username: u, email: em, password: p, confirm_password: c, redirect: document.getElementById('redirectInput').value })
        });
