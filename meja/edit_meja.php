    ...
    <form method="POST">
      <div class="form-row">
        <div class="form-group">
          ...
          <input type="text" name="nomor_meja" value="<?= htmlspecialchars($data['nomor_meja']) ?>" maxlength="10" required>
        </div>
        <div class="form-group">
          <label>Kapasitas (orang)</label>
          <input type="number" name="kapasitas" value="<?= $data['kapasitas'] ?>" min="1" max="20" required>
        </div>
      </div>
      <div class="form-group">
        <label>Status</label>
